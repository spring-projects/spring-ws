...
Here is an example of setting the `Action` header to `https://samples/RequestOrder`:

[source,java]
----
webServiceTemplate.marshalSendAndReceive(o, new ActionCallback("https://samples/RequestOrder"));
----
