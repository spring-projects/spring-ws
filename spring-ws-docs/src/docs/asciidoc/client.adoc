...
NOTE: If your organization needs additional rules on top of what the chosen sender already enforces, you can register a `DestinationPolicy` on that sender bean to accept or reject destinations before a connection is opened.
