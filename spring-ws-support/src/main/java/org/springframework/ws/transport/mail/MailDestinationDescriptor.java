...
public final class MailDestinationDescriptor implements DestinationDescriptor {
	...
	private MailDestinationDescriptor(URI uri, UriSource uriSource, InternetAddress toAddress, String mailboxHost) {
		this.uri = uri;
	...
	private static String extractMailboxHost(InternetAddress to) {
		if (to == null) {
			return null;
		}
