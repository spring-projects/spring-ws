...
/**
 * {@link WebServiceMessageSender} implementation that uses Mail {@link MimeMessage}s. Requires a
 * {@link #setTransportUri(String) transport} and {@link #setStoreUri(String) store} URI to be set.
 * <p>
 ...
 * themselves. The <i>to</i> represents a RFC 822 mailbox. Valid <i>param-name</i> include: <blockquote>
 * <table>
 * <tr>
...
public class MailMessageSender implements WebServiceMessageSender, InitializingBean {
	 ...
	 * <p>
	 * A new {@link Session} will be created with those properties. Use either this method or {@link #setSession}, but not
	 * both.
	 * <p>
	...
	/**
	 * Set the sleep time to use for receive calls, <strong>in milliseconds</strong>. The default is 1000 * 60 ms, that is
	 * 1 minute.
	 */
	...
	public WebServiceConnection createConnection(URI uri) throws IOException {
		...
		MailSenderConnection connection = new MailSenderConnection(session, transportUri, storeUri, to, receiveSleepTime);
		if (from != null) {
