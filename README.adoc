...
image:https://jenkins.spring.io/job/spring-ws/job/main/badge/icon[link='https://jenkins.spring.io/job/spring-ws/job/main/']
image:https://jenkins.spring.io/job/spring-ws/job/3.1.x/badge/icon[link='https://jenkins.spring.io/job/spring-ws/job/3.1.x/']
