...
<!DOCTYPE xsl:stylesheet [
    ...
    <!ENTITY admon_gfx_path     "../pdf/images/admons/">
]>
                ...
                <fo:table-body>
                    <fo:table-row>
                        <fo:table-cell text-align="center">
                            <fo:block font-family="Helvetica" font-size="36pt" padding-before="10mm">
                    ...
                    <fo:table-row>
                        <fo:table-cell text-align="center">
                            <fo:block font-family="Helvetica" font-size="12pt" padding="10mm">
                                <xsl:text>Copyright (c) 2006 </xsl:text>
...
<!--###################################################
    ...
    <!-- This footer prints the Spring Web Services version number on the left side -->
