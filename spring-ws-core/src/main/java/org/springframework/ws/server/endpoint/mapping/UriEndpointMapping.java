...
/**
 * Implementation of the {@code EndpointMapping} interface to map from the full request
 ...
 * <p>
 * When the {@link #setUsePath(boolean) usePath} property is enabled, the mapping will be
 ...
 * the {@link SaajSoapMessageFactory} with the {@code
...
public class UriEndpointMapping extends AbstractMapBasedEndpointMapping {
	...
	/**
	 * Indicates whether the path should be used instead of the full URI. Default is
	 * {@code false}.
	 * @since 2.1.1
	 */
