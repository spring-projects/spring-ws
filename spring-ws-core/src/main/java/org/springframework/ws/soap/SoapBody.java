...
/**
 * Represents the {@code Body} element in a SOAP message. A SOAP body contains the
 * <strong>payload</strong> of the message. This payload can be custom XML, or a
 * {@code SoapFault} (but not both).
 * <p>
 * Note that the source returned by {@code getSource()} includes the SOAP Body element
...
public interface SoapBody extends SoapElement {
	...
	/**
	 * Adds a {@code MustUnderstand} fault to the body. A {@code MustUnderstand} is
	 * returned when a SOAP header with a {@code MustUnderstand} attribute is not
	 * understood.
	 * <p>
	 ...
	 * fault with a {@code Client} fault code. For SOAP 1.2, this adds a fault with a
	 * {@code Sender} code.
	 * <p>
	 * Adding a fault removes the current content of the body.
	 * @param faultStringOrReason the SOAP 1.1 fault string or SOAP 1.2 reason text
	 ...
	 * fault with a {@code Server} fault code. For SOAP 1.2, this adds a fault with a
	 * {@code Receiver} code.
	 * <p>
	 * Adding a fault removes the current content of the body.
	 * @param faultStringOrReason the SOAP 1.1 fault string or SOAP 1.2 reason text
