...
public final class HttpDestinationDescriptor implements DestinationDescriptor {
	...
	private final Supplier<InetAddress> simpleHostAddressResolver = SingletonSupplier
		.of(() -> resolveHostAddress(false));

	private final Supplier<InetAddress> dnsResolutionHostAddressResolver = SingletonSupplier
	 ...
	 */
	public InetAddress hostAddress(boolean allowDnsResolution) {
	...
	private InetAddress resolveHostAddress(boolean allowDnsResolution) {
