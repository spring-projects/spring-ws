...
public abstract class AbstractSoap11MessageFactoryTests extends AbstractSoapMessageFactoryTests {
	...
	public void testCreateSoapMessageNoAttachment() throws Exception {
		...
		InputStream is = AbstractSoap11MessageFactoryTests.class.getResourceAsStream("soap11.xml");
	...
	public void doTestCreateSoapMessageIllFormedXml() throws Exception {
		...
		InputStream is = AbstractSoap11MessageFactoryTests.class.getResourceAsStream("soap11-ill-formed.xml");
		Map<String, String> headers = new HashMap<>();
		headers.put("Content-Type", "text/xml");
		TransportInputStream tis = new MockTransportInputStream(is, headers);
	...
	public void testCreateSoapMessageSwA() throws Exception {
		...
		InputStream is = AbstractSoap11MessageFactoryTests.class.getResourceAsStream("soap11-attachment.bin");
		Map<String, String> headers = new HashMap<>();
	...
	void testCreateSoapMessageUtf8ByteOrderMark() throws Exception {
		...
		SoapMessage message = (SoapMessage) this.messageFactory.createWebServiceMessage(tis);
