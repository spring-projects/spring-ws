...
public abstract class AbstractSoap12MessageTests extends AbstractSoapMessageTests {
	...
	protected final Resource[] getSoapSchemas() {
		...
		return new Resource[] { new ClassPathResource("xml.xsd", AbstractSoap12MessageTests.class),
				new ClassPathResource("soap12.xsd", AbstractSoap12MessageTests.class) };
	}
