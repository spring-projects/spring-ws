...
import org.springframework.ws.soap.AbstractSoapMessageFactoryTests;
...
public abstract class AbstractSoap12MessageFactoryTests extends AbstractSoapMessageFactoryTests {
	...
	public void testCreateSoapMessageNoAttachment() throws Exception {
		...
		InputStream is = AbstractSoap12MessageFactoryTests.class.getResourceAsStream("soap12.xml");
	...
	public void doTestCreateSoapMessageIllFormedXml() throws Exception {
		...
		InputStream is = AbstractSoap12MessageFactoryTests.class.getResourceAsStream("soap12-ill-formed.xml");
		Map<String, String> headers = new HashMap<>();
	...
	public void testCreateSoapMessageSwA() throws Exception {
		...
		InputStream is = AbstractSoap12MessageFactoryTests.class.getResourceAsStream("soap12-attachment.bin");
		Map<String, String> headers = new HashMap<>();
	...
	public void testCreateSoapMessageMtom() throws Exception {
		...
		InputStream is = AbstractSoap12MessageFactoryTests.class.getResourceAsStream("soap12-mtom.bin");
		Map<String, String> headers = new HashMap<>();
