...
public abstract class AbstractSoap11MessageFactoryTest extends AbstractSoapMessageFactoryTest {
	...
	public void testCreateSoapMessageUtf8ByteOrderMark() throws Exception {
		...
		InputStream is = AbstractSoap11MessageFactoryTest.class.getResourceAsStream("soap11-utf8-bom.xml");
		Map<String, String> headers = new HashMap<>();
