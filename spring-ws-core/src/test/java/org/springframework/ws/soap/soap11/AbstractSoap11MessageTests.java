...
import org.springframework.ws.soap.AbstractSoapMessageTests;
...
public abstract class AbstractSoap11MessageTests extends AbstractSoapMessageTests {

	@Override
	protected final Resource[] getSoapSchemas() {
		return new Resource[] { new ClassPathResource("soap11.xsd", AbstractSoap11MessageTests.class) };
	}

	@Override
	public void testGetVersion() {
		assertThat(this.soapMessage.getVersion()).isEqualTo(SoapVersion.SOAP_11);
	}
