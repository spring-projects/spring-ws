...
class MapBasedSoapEndpointMappingTests {
	...
	void getEndpointMappedSetsLookupKeyProperty() throws Exception {
		...
		assertThat(messageContext.getProperty(AbstractEndpointMapping.LOOKUP_KEY_PROPERTY)).isEqualTo("endpoint1");
	}
	...
	void getEndpointUnmappedDoesNotSetLookupKeyProperty() throws Exception {
		...
		mapping.getEndpointInternal(messageContext);
		assertThat(messageContext.getProperty(AbstractEndpointMapping.LOOKUP_KEY_PROPERTY)).isNull();
	}
